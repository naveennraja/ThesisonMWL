...
angular.module('web-tasks').controller("complexTaskController",complexTaskController);
function complexTaskController() {
    var vm = this,
        duration = 360,
        dataValue,
        timerId = document.querySelector('.count-down-timer');
        vm.title = "Complex Task";
        vm.data = {
            "times-zoomed-in":0,
            "times-zoomed-out":0,
            "total-time-spent":0,
    ...
    function trackAllEvents(duration,display) {
        ...
        var checkCountry ={
            "0":["Panama","Cuba","Puerto Rico","Dominican Rep","Haiti","Jamaica","Costa Rica","Honduras","El Salvador","Guatemala","Trinidad and Tobago"],
            "1":["Azerbaijan","Armenia","Georgia","Iran","Turkey","Turkmenistan","Lebanon","Syria"],
            "2":["Mauritius","Madagascar","Mozambique","Comoros","Malawi","Zambia","Zimbabwe","Swaziland","South Africa","Namibia","Angola"],
            "3":["Lithuania","Latvia","Estonia","Finland","Belarus","Poland","Denmark"],
            "4":["Bulgaria","Romania","Poland","Ukraine","Moldova","Serbia","Macedonia FYR","Hungary","Slovak Republic"],
            "5":["Finland","Denmark","Ireland","Sweden","Norway","United Kingdom","Netherlands","Belgium"],
            "6":["Slovenia","Croatia","Montenegro","Slovak Republic","Bosnia and Herzegovina","Belarus","Italy","Austria","Czech Rep","Hungary","Serbia"],
            "7":["Oman","Kuwait","Qatar","United Arab Emirates","Yemen","Iraq","Bahrain","Iran","Saudi Arabia"],
            "8":["Sri Lanka","India","Myanmar","Thailand","Laos","Cambodia","Malaysia","Hong Kong","Indonesia","Philippines","Singapore"]
        };
        var timer, min, sec;
        ...
        $(document).on("click", "body", function (e) {
            e.stopPropagation();
            var target = $(e.target);
            console.log("target",target,dataValue);
            if(target.is("circle"))  recordEvents(target);
        ...
        function recordEvents(target) {
            ...
            if(text === undefined && dataValue === undefined){
                ...
                if(checkCountry[idx].includes(dataValue) == true){
...
// Themes begin/*** ---------------------------------------* This demo was created using amCharts 4.** For more information visit:* https://www.amcharts.com/** Documentation is available at:* https://www.amcharts.com/docs/v4/* ---------------------------------------*/
// Themes begin/*** ---------------------------------------* This demo was created using amCharts 4.** For more information visit:* https://www.amcharts.com/** Documentation is available at:* https://www.amcharts.com/docs/v4/* ---------------------------------------*//*** --------------------------------------- * This demo was created using amCharts 4. * * For more information visit * https://www.amcharts.com/** Documentation is available at:* https://www.amcharts.com/docs/v4/* ---------------------------------------*/
// Themes begin/*** ---------------------------------------* This demo was created using amCharts 4.** For more information visit:* https://www.amcharts.com/** Documentation is available at:* https://www.amcharts.com/docs/v4/* ---------------------------------------*/
// Themes begin/*** ---------------------------------------* This demo was created using amCharts 4.** For more information visit:* https://www.amcharts.com/*\* Documentation is available at:* https://www.amcharts.com/docs/v4/* ---------------------------------------*/
// Themes begin
...
// Create map polygon series
        ...
        circle.events.on("hit", function(ev) {
            var population  = ev.target.dataItem.dataContext.value;
            dataValue = ev.target.dataItem.dataContext.name;
            console.log(ev.target.dataItem.dataContext.name);
            population = population.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            chart.closeAllPopups();
            var popup = chart.openPopup("<strong>" + ev.target.dataItem.dataContext.name + "</strong> population is: <strong>"+population+"</strong>");
            popup.left = ev.svgPoint.x + -25;
            popup.top = ev.svgPoint.y + -25;
